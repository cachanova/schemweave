...
pub(crate) use readability::{
    measure_parallel_congestion_bounded, measure_parallel_congestion_profile_with_budget,
};
...
fn layout_indexed(
            ...
            )
    {
        ...
        if candidate.width <= layout.width * routing::MAX_PITCHED_GAP_WIDTH_FACTOR
